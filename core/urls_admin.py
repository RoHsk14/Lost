...
urlpatterns = [
    ...
    path('agents/<int:agent_id>/', views_admin.agent_detail, name='agent_detail'),
    ...
    path('conversations/', views_admin.conversations_monitoring, name='conversations_monitoring'),
    
    # Supervision avancée des objets
