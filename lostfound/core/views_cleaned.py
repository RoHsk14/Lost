...
from .models import Signalement, Objet, Utilisateur, Region, Prefecture, StructureLocale
from .forms import SignalementForm, SearchForm, AdminForm
...
# ---------------------------
# Superadmin Views - Gestion des admins
# ---------------------------
@login_required
...
def admin_dashboard(request):
    # Note: 'zone' field doesn't exist in current model, using region instead
